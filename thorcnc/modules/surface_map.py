...
class SurfaceMapModule(ThorModule):
    ...
    def _build_params_panel(self) -> QFrame:
        ...
        grid1.setContentsMargins(14, 22, 16, 14)
        grid1.setColumnMinimumWidth(0, 126)
        grid1.setColumnMinimumWidth(1, 194)
        ...
        grid2.setContentsMargins(14, 22, 16, 14)
        grid2.setColumnMinimumWidth(0, 126)
        grid2.setColumnMinimumWidth(1, 194)
